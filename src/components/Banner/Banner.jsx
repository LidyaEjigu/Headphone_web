                ...
                <div className='flex flex-cols justify-center'>
                    <div className='text-center md:text-left space-y-4 lg:max-w-[450px'>
                        ...
                        <motion.p
                         ...
                         initial= "hidden"
                         whileInView= "show">
                        Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ab, eum! Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ab, eum! Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ab, eum! Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ab, eum!

                        </motion.p> {/*this is when the button is hover */}
                        <UpdateFollower 
                        mouseOptions={{
